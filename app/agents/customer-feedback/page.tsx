...
export const metadata: Metadata = { title: "AI Customer Feedback Calls | Erlang Labs", description: "Use AI voice agents to collect customer feedback through natural phone conversations and turn open answers into structured insights.", alternates: { canonical: "https://www.erlanglabs.com/agents/customer-feedback" } };
