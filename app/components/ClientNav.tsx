...
export function ClientNav() {
  ...
  return <>
    <nav aria-label="Primary navigation" className="site-nav hidden items-center lg:flex">
      ...
      <Link href="/plans" className={`nav-link nav-pill ${isActive("/plans") ? "nav-pill--active nav-link--active" : ""}`}>Plans</Link>
